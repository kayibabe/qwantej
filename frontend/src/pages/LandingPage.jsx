...
function PreviewSignalCard({ signal, rank }) {
  ...
  return (
    <div className={`relative rounded-2xl border bg-white/5 backdrop-blur-sm overflow-hidden transition-all duration-300 hover:-translate-y-1 ${
      ...
      {signal.locked && (
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center backdrop-blur-sm bg-[#0c1020]/60 rounded-2xl">
...
function LandingNav({ onSignIn, onSignUp }) {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      scrolled ? 'bg-[#0c1020]/95 backdrop-blur-md border-b border-white/10 shadow-[0_4px_24px_rgba(0,0,0,0.4)]' : 'bg-transparent'
    }`}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        {/* Logo */}
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 rounded-lg bg-blue-500/30 border border-blue-500/40 flex items-center justify-center">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={onSignUp}
            className="text-sm font-semibold px-4 py-1.5 rounded-lg bg-blue-500 hover:bg-blue-400 text-white transition-colors cursor-pointer">
            Get Free Picks
          </button>
      ...
      {/* Mobile menu */}
      {mobileOpen && (
        <div className="md:hidden bg-[#0c1020]/98 border-t border-white/10 px-4 py-4 space-y-2">
          {[['how-it-works', 'How It Works'], ['signals-preview', 'Signals'], ['pricing', 'Pricing']].map(([id, label]) => (
            <button key={id} onClick={() => scrollTo(id)}
...
export default function LandingPage({ onSignIn, onSignUp }) {
  return (
    <div className="min-h-screen bg-[#0c1020] text-white selection:bg-blue-500/30">
      ...
      <section className="relative overflow-hidden pt-20 pb-24 px-4 sm:px-6">
        ...
        <div className="absolute top-20 left-1/4 w-[300px] h-[300px] bg-blue-800/8 rounded-full blur-3xl pointer-events-none" />

        <div className="relative max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-500/15 border border-blue-500/30 text-blue-300 text-xs font-medium mb-6">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-white leading-[1.1] tracking-tight mb-5">
            Smarter Picks.{' '}
            <span className="text-blue-400">Better Returns.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-10">
            <button onClick={onSignUp}
              className="flex items-center gap-2 px-6 py-3 rounded-xl bg-blue-500 hover:bg-blue-400 text-white font-semibold text-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(168,85,247,0.4)] cursor-pointer">
              Get Free Picks
      ...
      <section id="signals-preview" className="py-20 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-xs uppercase tracking-widest text-blue-400 font-medium mb-3">Live Signal Preview</p>
          ...
          <div className="text-center">
            <button onClick={onSignUp}
              className="inline-flex items-center gap-2 text-sm text-blue-400 hover:text-blue-300 font-medium transition-colors cursor-pointer group">
      ...
      <section id="how-it-works" className="py-20 px-4 sm:px-6 bg-white/[0.02]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-xs uppercase tracking-widest text-blue-400 font-medium mb-3">The Process</p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {HOW_IT_WORKS.map(({ icon: Icon, title, desc }, i) => (
              <div key={title} className="relative rounded-2xl border border-white/10 bg-white/5 p-6 hover:border-blue-500/30 hover:-translate-y-1 transition-all duration-300">
      ...
      <section id="pricing" className="py-20 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-xs uppercase tracking-widest text-blue-400 font-medium mb-3">Simple Pricing</p>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
            ...
            {/* Pro */}
            <div className="rounded-2xl border border-blue-500/50 bg-blue-500/10 p-6 relative overflow-hidden">
              <div className="absolute top-4 right-4">
                <span className="text-[10px] font-bold px-2.5 py-1 rounded-full bg-blue-500 text-white">MOST POPULAR</span>
              </div>
              <div className="mb-6">
                <p className="text-xs text-blue-300 uppercase tracking-widest mb-1">Pro</p>
                <div className="flex items-end gap-1">
              ...
              <button onClick={onSignUp}
                className="w-full py-2.5 rounded-xl bg-blue-500 hover:bg-blue-400 text-sm font-semibold text-white transition-all hover:-translate-y-0.5 hover:shadow-[0_6px_20px_rgba(168,85,247,0.4)] cursor-pointer">
                Start Pro — $9/month
              </button>
            </div>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 border-t border-white/8">
        <div className="max-w-5xl mx-auto text-center">
          <p className="text-xs uppercase tracking-widest text-blue-400 font-medium mb-3">Coverage</p>
      ...
      <section className="py-20 px-4 sm:px-6">
        <div className="max-w-2xl mx-auto text-center">
          <div className="relative rounded-3xl border border-blue-500/30 bg-blue-500/10 p-10 overflow-hidden">
            ...
            <button onClick={onSignUp}
              className="inline-flex items-center gap-2 px-8 py-3 rounded-xl bg-blue-500 hover:bg-blue-400 text-white font-semibold text-sm transition-all hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(168,85,247,0.5)] cursor-pointer">
              Get Free Picks Now
              <ArrowRight className="w-4 h-4" />
            </button>
          </div>
          ...
          <div className="grid sm:grid-cols-3 gap-8 mb-10">
            <div>
              <div className="flex items-center gap-2 mb-3">
                <div className="w-6 h-6 rounded-md bg-blue-500/30 border border-blue-500/40 flex items-center justify-center">
