...
const CATEGORY_META = {
  ...
  home_team_blank:       { label: 'Home Blank',             color: 'bg-blue-500/15 text-blue-400 border-blue-500/30' },
  end_of_season:         { label: 'End of Season',          color: 'bg-blue-500/15 text-blue-400 border-blue-500/30' },
