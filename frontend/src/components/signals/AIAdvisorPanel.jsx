...
<head>
  ...
  <title>Qwantej AI Advisory Report — ${reportDate}</title>
  <style>
    @media print {
      body { margin: 0; }
...
<div class="page">
  ...
  <div style="border-bottom:2px solid #7c3aed;padding-bottom:16px;margin-bottom:24px;">
    <div style="display:flex;align-items:flex-start;justify-content:space-between;flex-wrap:wrap;gap:12px;">
      <div>
        <h1 style="margin:0;font-size:22px;color:#7c3aed;letter-spacing:-.3px;">Qwantej</h1>
  ...
  <div style="margin-top:28px;padding:12px 16px;background:#fafafa;border:1px solid #e5e7eb;border-radius:8px;font-size:11px;color:#9ca3af;line-height:1.6;">
    ...
    This report was generated by Qwantej's AI Advisory Council (Scout · Strategist · Skeptic).
...
function exportWord(data, date) {
  ...
  a.href     = url
  a.download = `Qwantej-advisory-${slug}.doc`
  a.click()
