...
2024-05-10,Man City vs Arsenal,Over 2.5,1.85,50000,Betway,Won,derby day
2024-05-10,Liverpool vs Chelsea,BTTS Yes,1.72,50000,Betway,Lost,`
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-[var(--border)]">
          <div>
            ...
            <p className="text-xs text-[var(--text)] opacity-80 mt-0.5">
              Columns: date, match, market, odds, stake (+ optional: bookmaker, result, notes)
            </p>
          </div>
                      ...
                      <tbody>
                        {preview.map((row, i) => (
                          <tr key={i} className="border-t border-[var(--border)]">
                            ...
                            <td className="px-3 py-1.5 font-mono text-[var(--text-h)]">{row.stake.toLocaleString()}</td>
